...
export const countries: Country[] = [
  {
    ...
    content: {
      ...
      cta: {
        heading: "გაგზავნეთ ამანათი საქართველოდან პოლონეთში Parcello-სთან ერთად",
        body: "არ გაართულოთ ამანათის გაგზავნა ევროპაში.",
        emphasis: "მოგვწერეთ დღესვე და გაიგეთ ამანათის გაგზავნის ფასი პოლონეთში.",
      },
    },
  },
  {
    ...
    content: {
      ...
      narrative: [
        {
          ...
          sources: [
            {
              label: "German Federal Foreign Office — Germany and Georgia: Bilateral relations",
      ...
      faqs: [
        ...
        {
          question: "შემიძლია თუ არა ამანათის გაგზავნა ბერლინში, ფრანკფურტში ან მიუნხენში?",
          answer:
      ...
      cta: {
        heading: "გაგზავნეთ ამანათი საქართველოდან გერმანიაში Parcello-სთან ერთად",
