...
export const ui: UiStrings = {
  ...
  pages: {
    ...
    services: {
      metaTitle: "სერვისები",
      metaDescription:
        "Parcello-ს სერვისები — ამანათის გაგზავნა საქართველოდან ევროპაში, ამანათის გამოგზავნა საბერძნეთიდან და პოლონეთიდან საქართველოში, ონლაინ შოპინგი ევროპიდან და კომერციული ტვირთების ტრანსპორტირება.",
